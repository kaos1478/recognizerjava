...
public class RegisterPerson extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Sistema de Segurança - Registrar Pessoa");
        ...
        jLabel4.setText("Office (Cargo):");
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 90, -1, -1));
        ...
        jPanel3.add(txt_dob, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 110, 170, -1));

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, 420, 150));

        jButton1.setBackground(new java.awt.Color(104, 165, 197));
        ...
        jButton2.setBackground(new java.awt.Color(110, 197, 104));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 250, 100, -1));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 450, 410));

        setSize(new java.awt.Dimension(457, 330));
